...
public class ZodiacVirgoLayout extends Layout {
    ...
    public void init() {
        ...
        places.add(new Place(13, 1, 0));

        // 1,5. sor
        places.add(new Place(15.5, 1.5, 0));
        ...
        // 2,5. sor
        places.add(new Place(15.5, 2.5, 0));
        ...
        // 4,5. sor
        places.add(new Place(14.5, 4.5, 0));
        ...
        // 8. sor
        places.add(new Place(9.5, 8, 0));

        places.add(new Place(12, 8, 0));
        places.add(new Place(13, 8, 0));
        ...
        places.add(new Place(9, 0.5, 2));
        places.add(new Place(11, 0.5, 2));
        ...
        places.add(new Place(12.5, 6, 2));

        // 7. sor
        places.add(new Place(2.5, 7, 2));

        places.add(new Place(7.5, 7, 2));

        places.add(new Place(12.5, 7, 2));

        // 8. sor
        places.add(new Place(12.5, 8, 2));
