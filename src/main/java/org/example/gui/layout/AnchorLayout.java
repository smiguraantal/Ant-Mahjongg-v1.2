...
public class AnchorLayout extends Layout {
    ...
    public void init() {
        ...
        // 3,5. sor
        places.add(new Place(4.5, 3.5, 0));
        places.add(new Place(5.5, 3.5, 0));
        places.add(new Place(8.5, 3.5, 0));
        places.add(new Place(9.5, 3.5, 0));
        ...
        places.add(new Place(13, 2.5, 1));

        // 3. sor
        places.add(new Place(0, 3, 1));

        places.add(new Place(6.5, 3, 1));
        places.add(new Place(7.5, 3, 1));

        places.add(new Place(14, 3, 1));

        // 3,5. sor
        places.add(new Place(4.5, 3.5, 1));
        places.add(new Place(5.5, 3.5, 1));
        places.add(new Place(8.5, 3.5, 1));
        places.add(new Place(9.5, 3.5, 1));
