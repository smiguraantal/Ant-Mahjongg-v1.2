...
public class WindXiLayout extends Layout {
    ...
    public void init() {
        ...
        // 1. sor
        places.add(new Place(2.5, 1, 3));
        places.add(new Place(4.5, 1, 3));
        ...
        places.add(new Place(2.5, 3, 3));
        places.add(new Place(4.5, 3, 3));
        places.add(new Place(8, 3, 3));

        // 4. sor
        places.add(new Place(0, 4, 3));
        places.add(new Place(2, 4, 3));
