...
public class CarLayout extends Layout {
    ...
    public void init() {
        ...
        places.add(new Place(10.5, 4, 2));

        // 5. sor
        places.add(new Place(0.5, 5, 2));
