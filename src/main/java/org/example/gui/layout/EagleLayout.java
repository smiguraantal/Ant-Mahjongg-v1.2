...
public class EagleLayout extends Layout {
    ...
    public void init() {
        ...
        // 6,5. sor
        places.add(new Place(3, 6.5, 1));
        places.add(new Place(4, 6.5, 1));

        places.add(new Place(7, 6.5, 1));
        places.add(new Place(8, 6.5, 1));
        ...
        // 2,5. sor
        places.add(new Place(3, 2.5, 2));
        places.add(new Place(4, 2.5, 2));
