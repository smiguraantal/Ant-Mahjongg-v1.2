...
public class StarLayout extends Layout {
    ...
    public void init() {
        ...
        // 4,5. sor
        places.add(new Place(3.5, 4.5, 0));
        places.add(new Place(4.5, 4.5, 0));

        places.add(new Place(6.5, 4.5, 0));
        ...
        // 4,5. sor
        places.add(new Place(3.5, 4.5, 1));
        places.add(new Place(4.5, 4.5, 1));

        places.add(new Place(6.5, 4.5, 1));
        ...
        // 4,5. sor
        places.add(new Place(3.5, 4.5, 2));
        places.add(new Place(4.5, 4.5, 2));
        ...
        places.add(new Place(7, 6.5, 2));

        places.add(new Place(9, 6.5, 2));
        ...
        // 2. sor
        places.add(new Place(3.5, 2, 3));
        places.add(new Place(4.5, 2, 3));

        places.add(new Place(6.5, 2, 3));
        places.add(new Place(7.5, 2, 3));
        ...
        // 4,5. sor
        places.add(new Place(3.5, 4.5, 3));

        places.add(new Place(7.5, 4.5, 3));
        ...
        // 6,5. sor
        places.add(new Place(4, 6.5, 3));

        places.add(new Place(7, 6.5, 3));
