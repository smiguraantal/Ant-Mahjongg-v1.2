...
public class ChessRookLayout extends Layout {

    public void init() {
        // 0. réteg
        // 0. sor
        places.add(new Place(1.5, 0, 0));
        ...
        // 3. réteg
        // 0. sor
        places.add(new Place(1.5, 0, 3));
        places.add(new Place(3, 0, 3));
        places.add(new Place(4.5, 0, 3));
        places.add(new Place(6, 0, 3));
        places.add(new Place(7.5, 0, 3));
